...
if(isset($_POST['payment_id']) && isset($_POST['email'])){
	...
	$query1= "SELECT * FROM admission_b WHERE email='$email'";
	$data1 = mysqli_query($con,$query1);
	$rowcount1=mysqli_num_rows($data1);
	if($rowcount1==true){
	$users_registration_query="UPDATE admission_b set payment_status='complete',payment_id='$payment_id',payment_detail='$payment_detail' WHERE email='$email'";
